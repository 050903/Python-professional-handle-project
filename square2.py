...
def draw_3d_square(win, angle):
    ...
    for x, y, z in points:
        ...
        x_proj = x * factor + WIDTH//2 - 200  # offset to left
        y_proj = y * factor + HEIGHT//2
        projected.append((x_proj, y_proj))

    # draw square
    for i in range(4):
        pygame.draw.line(win, (200, 200, 0), projected[i], projected[(i+1)%4], 2)

def draw_3d_cube(win, angle_x, angle_y, angle_z):
    size = 100
    vertices = [
    ...
    for x, y, z in vertices:
        ...
        # project
        factor = 200 / (200 - z + 0.001)
        x_proj = x * factor + WIDTH//2 + 200  # offset to right
        y_proj = y * factor + HEIGHT//2
        projected.append((x_proj, y_proj))
...
def main():
    ...
    while running:
        ...
        # draw cube and square
        draw_3d_square(win, angle_square)
        draw_3d_cube(win, angle_x, angle_y, angle_z)
